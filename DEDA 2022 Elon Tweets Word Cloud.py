...
raw_text = open(cwd_dir + '/TweetsElonMusk.txt', 'r', encoding='utf-8').read() #!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# Mask
twitter_pic = np.array(Image.open(path.join(cwd_dir, "twitter-logo-vector-png-clipart-1.png")))
#ql_pic = np.array(Image.open(cwd_dir + '/twitter-logo-vector-png-clipart-1.png'))
...
wc = WordCloud(max_words=100, stopwords=stopword, mask=twitter_pic, mode='RGBA', background_color=None)
